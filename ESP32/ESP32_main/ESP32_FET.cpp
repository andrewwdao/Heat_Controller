...
void FET1pwm_init() {
  ...
  ledcAttachPin(FET1_PIN, PWM_CHANNEL_1);// attach the channel to the GPIO to be controlled
}//end FET1pwm_init
//------------------------------------
void FET1_ON() {
...
void FET1pwm_write(int PWMpercentage) {
  ledcWrite(PWM_CHANNEL_1, PWMpercentage*PWM_RESOLUTION/100); //output signal to the pump
}//end FET1pwm_write
//------------------------------------
void FET2_init() {
...
void FET2pwm_init() {
  ...
  ledcAttachPin(FET2_PIN, PWM_CHANNEL_2);// attach the channel to the GPIO to be controlled
}//end FET2pwm_init
//------------------------------------
void FET2_ON() {
...
void FET2pwm_write(int PWMpercentage) {
  ledcWrite(PWM_CHANNEL_2, PWMpercentage*PWM_RESOLUTION/100); //output signal to the pump
}//end FET1pwm_write
//------------------------------------
